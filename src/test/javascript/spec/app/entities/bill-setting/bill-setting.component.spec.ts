...
import { BillSettingComponent } from 'app/entities/bill-setting/bill-setting.component';
...
describe('Component Tests', () => {
    describe('BillSetting Management Component', () => {
        let comp: BillSettingComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(BillSettingComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.billSettings[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
