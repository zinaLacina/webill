...
import { MetersComponent } from 'app/entities/meters/meters.component';
import { MetersService } from 'app/entities/meters/meters.service';
import { Meters } from 'app/shared/model/meters.model';

describe('Component Tests', () => {
    describe('Meters Management Component', () => {
        let comp: MetersComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MetersComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.meters[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
