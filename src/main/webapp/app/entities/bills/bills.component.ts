...
export class BillsComponent implements OnInit, OnDestroy {
    ...
    setActive(bills, isAccepted){
        bills.enabled = isAccepted;
        console.log(bills);
        this.billsService.accept(bills).subscribe(response => {
    ...
    loadAll() {
        this.billsService
            ...
            .subscribe(
                (res: HttpResponse<IBills[]>) => this.paginateBills(res.body, res.headers),
    ...
    private paginateBills(data: IBills[], headers: HttpHeaders) {
